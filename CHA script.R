...
##because we are missing years we are going to convert lines to markers because...
...
#tonextx fills the color between to lines, transparent makes line invisible, showlegend =false so it doesnt show theline on the legend.warni
###Insured
#Cache
...
#Box Elder
fruit_cr <- fruit_cr %>% add_trace(y = ~be_fruit_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
fruit_cr <- fruit_cr %>% add_trace(y = ~br_fruit_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
fruit_cr <- fruit_cr %>% layout(title = 'Percent of Adults Consuming the Recommended Amount of Fruit',
                          xaxis = list(title = 'Year'),
                          yaxis = list(title = 'Percent'))e
##because we are missing years we are going to convert lines to markers because...


aa_fruit <- plot_ly(risk_wide, x=~Year, y=~ca_fruit_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_fruit <- aa_fruit %>% add_trace(y = ~be_fruit_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_fruit <- aa_fruit %>% add_trace(y = ~br_fruit_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
veg_cr <- veg_cr %>% add_trace(y = ~be_veg_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
veg_cr <- veg_cr %>% add_trace(y = ~br_veg_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_veg <- plot_ly(risk_wide, x=~Year, y=~ca_veg_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_veg <- aa_veg %>% add_trace(y = ~be_veg_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_veg <- aa_veg %>% add_trace(y = ~br_veg_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
phy_act_cr <- phy_act_cr %>% add_trace(y = ~be_phy_act_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
phy_act_cr <- phy_act_cr %>% add_trace(y = ~br_phy_act_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_phy_act <- plot_ly(risk_wide, x=~Year, y=~ca_phy_act_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_phy_act <- aa_phy_act %>% add_trace(y = ~be_phy_act_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_phy_act <- aa_phy_act %>% add_trace(y = ~br_phy_act_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
cig_smkng_cr <- cig_smkng_cr %>% add_trace(y = ~be_cig_smkng_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
cig_smkng_cr <- cig_smkng_cr %>% add_trace(y = ~br_cig_smkng_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_cig_smkng <- plot_ly(risk_wide, x=~Year, y=~ca_cig_smkng_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_cig_smkng <- aa_cig_smkng %>% add_trace(y = ~be_cig_smkng_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_cig_smkng <- aa_cig_smkng %>% add_trace(y = ~br_cig_smkng_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
ecig_cr <- plot_ly(risk_wide, x=~Year, y=~ca_ecig_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
ecig_cr <- ecig_cr %>% add_trace(y = ~ca_ecig_cr_uci, name = "Upper CI", line = list(color = 'transparent'), legendgroup = 'group1', showlegend = FALSE)
ecig_cr <- ecig_cr %>% add_trace(y = ~ca_ecig_cr_lci, name = "Lower CI", fill = 'tonextx', fillcolor = alpha(BRHD_cols[[1]], 0.2), line = list(color = 'transparent'), legendgroup = 'group1', showlegend = FALSE)
#Box Elder
ecig_cr <- ecig_cr %>% add_trace(y = ~be_ecig_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
ecig_cr <- ecig_cr %>% add_trace(y = ~be_ecig_cr_uci, name = "Upper CI", line = list(color = 'transparent'), legendgroup = 'group2', showlegend = FALSE)
ecig_cr <- ecig_cr %>% add_trace(y = ~be_ecig_cr_lci, name = "Lower CI", fill = 'tonextx', fillcolor = alpha(BRHD_cols[[3]], 0.2), line = list(color = 'transparent'), legendgroup = 'group2', showlegend = FALSE)
#BRHD
ecig_cr <- ecig_cr %>% add_trace(y = ~br_ecig_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_ecig <- plot_ly(risk_wide, x=~Year, y=~ca_ecig_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
aa_ecig <- aa_ecig %>% add_trace(y = ~ca_ecig_aar_uci, name = "Upper CI", line = list(color = 'transparent'), legendgroup = 'group1', showlegend = FALSE)
aa_ecig <- aa_ecig %>% add_trace(y = ~ca_ecig_aar_lci, name = "Lower CI", fill = 'tonextx', fillcolor = alpha(BRHD_cols[[1]], 0.2), line = list(color = 'transparent'), legendgroup = 'group1', showlegend = FALSE)
#Box Elder
aa_ecig <- aa_ecig %>% add_trace(y = ~be_ecig_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
aa_ecig <- aa_ecig %>% add_trace(y = ~be_ecig_aar_uci, name = "Upper CI", line = list(color = 'transparent'), legendgroup = 'group2', showlegend = FALSE)
aa_ecig <- aa_ecig %>% add_trace(y = ~be_ecig_aar_lci, name = "Lower CI", fill = 'tonextx', fillcolor = alpha(BRHD_cols[[3]], 0.2), line = list(color = 'transparent'), legendgroup = 'group2', showlegend = FALSE)
#BRHD
aa_ecig <- aa_ecig %>% add_trace(y = ~br_ecig_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
bnge_drnkng_cr <- bnge_drnkng_cr %>% add_trace(y = ~be_bnge_drnkng_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
bnge_drnkng_cr <- bnge_drnkng_cr %>% add_trace(y = ~br_bnge_drnkng_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_bnge_drnkng <- plot_ly(risk_wide, x=~Year, y=~ca_bnge_drnkng_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_bnge_drnkng <- aa_bnge_drnkng %>% add_trace(y = ~be_bnge_drnkng_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_bnge_drnkng <- aa_bnge_drnkng %>% add_trace(y = ~br_bnge_drnkng_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
st_blt_cr <- st_blt_cr %>% add_trace(y = ~be_st_blt_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
st_blt_cr <- st_blt_cr %>% add_trace(y = ~br_st_blt_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_st_blt <- plot_ly(risk_wide, x=~Year, y=~ca_st_blt_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_st_blt <- aa_st_blt %>% add_trace(y = ~be_st_blt_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_st_blt <- aa_st_blt %>% add_trace(y = ~br_st_blt_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
###
#Cache
inf_mort_rate <- plot_ly(outcomes_wide, x=~Year, y=~ca_inf_mort_rate, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
inf_mort_rate <- inf_mort_rate %>% add_trace(y = ~be_inf_mort_rate, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
inf_mort_rate <- inf_mort_rate %>% add_trace(y = ~br_inf_mort_rate, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
unint_inj_cr <- plot_ly(outcomes_wide, x=~Year, y=~ca_unint_inj_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
mvc_cr <- mvc_cr %>% add_trace(y = ~be_mvc_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
mvc_cr <- mvc_cr %>% add_trace(y = ~br_mvc_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_mvc <- plot_ly(outcomes_wide, x=~Year, y=~ca_mvc_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_mvc <- aa_mvc %>% add_trace(y = ~be_mvc_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_mvc <- aa_mvc %>% add_trace(y = ~br_mvc_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
drug_poi_cr <- drug_poi_cr %>% add_trace(y = ~be_drug_poi_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
drug_poi_cr <- drug_poi_cr %>% add_trace(y = ~br_drug_poi_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_drug_poi <- plot_ly(outcomes_wide, x=~Year, y=~ca_drug_poi_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_drug_poi <- aa_drug_poi %>% add_trace(y = ~be_drug_poi_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_drug_poi <- aa_drug_poi %>% add_trace(y = ~br_drug_poi_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
falls_cr <- falls_cr %>% add_trace(y = ~be_falls_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
falls_cr <- falls_cr %>% add_trace(y = ~br_falls_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_falls <- plot_ly(outcomes_wide, x=~Year, y=~ca_falls_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_falls <- aa_falls %>% add_trace(y = ~be_falls_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_falls <- aa_falls %>% add_trace(y = ~br_falls_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
sui_cr <- sui_cr %>% add_trace(y = ~be_sui_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
sui_cr <- sui_cr %>% add_trace(y = ~br_sui_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_sui <- plot_ly(outcomes_wide, x=~Year, y=~ca_sui_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_sui <- aa_sui %>% add_trace(y = ~be_sui_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_sui <- aa_sui %>% add_trace(y = ~br_sui_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Cache
mort_diab_cr <- plot_ly(outcomes_wide, x=~Year, y=~ca_mort_diab_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Cache
mort_cvs_cr <- plot_ly(outcomes_wide, x=~Year, y=~ca_mort_cvs_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
mort_lung_can_cr <- plot_ly(outcomes_wide, x=~Year, y=~ca_mort_lung_can_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
mort_lung_can_cr <- mort_lung_can_cr %>% add_trace(y = ~ca_mort_lung_can_cr_uci, name = "Upper CI", line = list(color = 'transparent'), legendgroup = 'group1', showlegend = FALSE)
mort_lung_can_cr <- mort_lung_can_cr %>% add_trace(y = ~ca_mort_lung_can_cr_lci, name = "Lower CI", fill = 'tonextx', fillcolor = alpha(BRHD_cols[[1]], 0.2), line = list(color = 'transparent'), legendgroup = 'group1', showlegend = FALSE)
#Box Elder
mort_lung_can_cr <- mort_lung_can_cr %>% add_trace(y = ~be_mort_lung_can_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
mort_lung_can_cr <- mort_lung_can_cr %>% add_trace(y = ~be_mort_lung_can_cr_uci, name = "Upper CI", line = list(color = 'transparent'), legendgroup = 'group2', showlegend = FALSE)
mort_lung_can_cr <- mort_lung_can_cr %>% add_trace(y = ~be_mort_lung_can_cr_lci, name = "Lower CI", fill = 'tonextx', fillcolor = alpha(BRHD_cols[[3]], 0.2), line = list(color = 'transparent'), legendgroup = 'group2', showlegend = FALSE)
#BRHD
mort_lung_can_cr <- mort_lung_can_cr %>% add_trace(y = ~br_mort_lung_can_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
mort_lung_can_cr <- mort_lung_can_cr %>% add_trace(y = ~br_mort_lung_can_cr_uci, name = "Upper CI", line = list(color = 'transparent'), legendgroup = 'group3', showlegend = FALSE)
mort_lung_can_cr <- mort_lung_can_cr %>% add_trace(y = ~br_mort_lung_can_cr_lci, name = "Lower CI", fill = 'tonextx', fillcolor = alpha(BRHD_cols[[4]], 0.2), line = list(color = 'transparent'), legendgroup = 'group3', showlegend = FALSE)
#Layout
mort_lung_can_cr <- mort_lung_can_cr %>% layout(title = 'Lung Cancer Mortality Rates by County',
                                      xaxis = list(title = 'Year'),
                                      yaxis = list(title = 'Mortality Rate (per 100,000)'))
##because we are missing years we are going to convert lines to markers because...

aa_mort_lung_can <- plot_ly(outcomes_wide, x=~Year, y=~ca_mort_lung_can_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_mort_lung_can <- aa_mort_lung_can %>% add_trace(y = ~be_mort_lung_can_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_mort_lung_can <- aa_mort_lung_can %>% add_trace(y = ~br_mort_lung_can_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
mort_brst_can_cr <- mort_brst_can_cr %>% add_trace(y = ~be_mort_brst_can_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
mort_brst_can_cr <- mort_brst_can_cr %>% add_trace(y = ~br_mort_brst_can_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_mort_brst_can <- plot_ly(outcomes_wide, x=~Year, y=~ca_mort_brst_can_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_mort_brst_can <- aa_mort_brst_can %>% add_trace(y = ~be_mort_brst_can_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_mort_brst_can <- aa_mort_brst_can %>% add_trace(y = ~br_mort_brst_can_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
mort_colrect_can_cr <- mort_colrect_can_cr %>% add_trace(y = ~be_mort_colrect_can_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
mort_colrect_can_cr <- mort_colrect_can_cr %>% add_trace(y = ~br_mort_colrect_can_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_mort_colrect_can <- plot_ly(outcomes_wide, x=~Year, y=~ca_mort_colrect_can_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_mort_colrect_can <- aa_mort_colrect_can %>% add_trace(y = ~be_mort_colrect_can_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_mort_colrect_can <- aa_mort_colrect_can %>% add_trace(y = ~br_mort_colrect_can_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
mort_pros_can_cr <- mort_pros_can_cr %>% add_trace(y = ~be_mort_pros_can_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
mort_pros_can_cr <- mort_pros_can_cr %>% add_trace(y = ~br_mort_pros_can_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_mort_pros_can <- plot_ly(outcomes_wide, x=~Year, y=~ca_mort_pros_can_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_mort_pros_can <- aa_mort_pros_can %>% add_trace(y = ~be_mort_pros_can_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_mort_pros_can <- aa_mort_pros_can %>% add_trace(y = ~br_mort_pros_can_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
mort_skin_can_cr <- mort_skin_can_cr %>% add_trace(y = ~be_mort_skin_can_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
mort_skin_can_cr <- mort_skin_can_cr %>% add_trace(y = ~br_mort_skin_can_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_mort_skin_can <- plot_ly(outcomes_wide, x=~Year, y=~ca_mort_skin_can_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_mort_skin_can <- aa_mort_skin_can %>% add_trace(y = ~be_mort_skin_can_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_mort_skin_can <- aa_mort_skin_can %>% add_trace(y = ~br_mort_skin_can_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Box Elder
rape_cr <- rape_cr %>% add_trace(y = ~be_rape_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
rape_cr <- rape_cr %>% add_trace(y = ~br_rape_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Layout
rape_cr <- rape_cr %>% layout(title = 'Percent of Adults Who have Experienced Rape or Attempted Rape',
                                                xaxis = list(title = 'Year'),
                                                yaxis = list(title = 'Percent'))
##because we are missing years we are going to convert lines to markers because...

aa_rape <- plot_ly(outcomes_wide, x=~Year, y=~ca_rape_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_rape <- aa_rape %>% add_trace(y = ~be_rape_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_rape <- aa_rape %>% add_trace(y = ~br_rape_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
phy_hlth_cr <- plot_ly(outcomes_wide, x=~Year, y=~ca_phy_hlth_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
ment_hlth_cr <- plot_ly(outcomes_wide, x=~Year, y=~ca_ment_hlth_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
arthrits_cr <- arthrits_cr %>% add_trace(y = ~be_arthrits_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
arthrits_cr <- arthrits_cr %>% add_trace(y = ~br_arthrits_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_arthrits <- plot_ly(outcomes_wide, x=~Year, y=~ca_arthrits_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_arthrits <- aa_arthrits %>% add_trace(y = ~be_arthrits_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_arthrits <- aa_arthrits %>% add_trace(y = ~br_arthrits_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
#Cache
astma_cr <- plot_ly(outcomes_wide, x=~Year, y=~ca_astma_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
aa_astma <- aa_astma %>% layout(title = 'Age-Adjusted Percent of Adults Who Currently have Diagnosed Asthma',
                                      ...
                                      yaxis = list(title = 'Percent'))
#Cache
diab_cr <- plot_ly(outcomes_wide, x=~Year, y=~ca_diab_cr, type = 'scatter', mode = "marker", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
prediabets_cr <- prediabets_cr %>% add_trace(y = ~be_prediabets_cr, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
prediabets_cr <- prediabets_cr %>% add_trace(y = ~br_prediabets_cr, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
aa_prediabets <- plot_ly(outcomes_wide, x=~Year, y=~ca_prediabets_aar, type = 'scatter', mode = "lines", name = "Cache", line = list(color = BRHD_cols[[1]]), legendgroup = 'group1')
...
#Box Elder
aa_prediabets <- aa_prediabets %>% add_trace(y = ~be_prediabets_aar, type = 'scatter', mode = "lines", name = "Box Elder", line = list(color = BRHD_cols[[3]]), legendgroup = 'group2')
...
#BRHD
aa_prediabets <- aa_prediabets %>% add_trace(y = ~br_prediabets_aar, type = 'scatter', mode = "lines", name = "BRHD", line = list(color = BRHD_cols[[4]]), legendgroup = 'group3')
...
tmp.env$mort_lung_can_cr <- mort_lung_can_cr
...
save(list = ls(all.names = TRUE, pos = tmp.env), envir = tmp.env,
     file = "C:/Users/tstoker/Desktop/RWD/BRHD_CHA/dashdata.Rdata")
